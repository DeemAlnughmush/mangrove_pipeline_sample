...
Dataset Link:
[Roboflow Dataset](https://app.roboflow.com/blue-carbon-ai/mangrove_tree_instance/1)
...
The repository includes example outputs generated by the prototype pipeline:

### Single Monitoring Survey

A monitoring record generated from a single drone image.

File:
[View Sample Survey](sample_outputs/auto_filled_mangrove_survey.xlsx)

### Batch Monitoring Surveys

Monitoring records generated from multiple drone images, where each image is represented as a separate monitoring point.

File:
[View Batch Survey Records](sample_outputs/all_monitoring_surveys_full.xlsx)
...
3. Extract vegetation and health indicators.
...
Several environmental variables currently use simulated values for demonstration purposes. In the final system, these values will be automatically collected from GPS-linked weather services, GIS platforms, and environmental data sources.
